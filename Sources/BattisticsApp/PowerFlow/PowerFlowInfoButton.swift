    ...
    var body: some View {
        ...
        .popover(isPresented: $showingInfo, arrowEdge: .top) {
            VStack(alignment: .leading, spacing: 10) {
                ...
                Text("Readings can update slowly and at different times. They may not add up exactly. Battery arrows are hidden when direction is uncertain. Negative battery watts mean reported discharge; positive means reported charging. Missing readings appear as a dash, never an assumed zero.")
